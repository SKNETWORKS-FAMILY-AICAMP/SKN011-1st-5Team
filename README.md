...
| 신차구매 데이터 DB 구축 및 연동 | 25.02.25 | 25.02.26 | 성호진, 신준희 | DB table |
| faq 데이터 크롤링(현대, 기아) | 25.02.25 | 25.02.25 | 이민정, 현유경 | csv |
| faq 데이터 DB 구축 및 연동 | 25.02.25 | 25.02.25 | 현유경 | csv |
...
|:--:|:--:|:--:|:--:|:--:|
| T-01 | figma | **화면설계** | 화면 설계 | - |
| T-02 | ERD | **데이터 관계성 정립** | 데이터 관계성 정립 | - |
| V-01 | streamlit | **플랫폼 개발** | main page | 플랫폼이 필요한 이유 |
| V-02 | streamlit | **플랫폼 개발** | 연령대별 차량 추천 | - DEFAULT: 전체 순위<br>- 20대, 30대, 40대, 50대, 60대 이상 |
| V-03 | streamlit | **플랫폼 개발** | 금액대별 차량 추천 | - DEFAULT: 전체 순위<br>- 1000미만, 1000-2000, 2000-3000, 3000-4000, 4000-5000, 5000이상 |
| V-04 | streamlit | **플랫폼 개발** | FAQ | 현대, 기아 데이터 |
| C-01 | 크롤링 | **크롤링** | 신차 구매 데이터 크롤링 | 연령대별, 금액대별 데이터 |
